...
pub fn install_nix_config(device: &str) {
    ...
    exec_eval(
        exec(
            ...
            vec![
                ...
                String::from("https://codeload.github.com/8E1P2E8/athena-nix-experiment-dory/zip/refs/heads/master"),
            ],
            OnFail::Error,
        ),
    ...
    exec_eval(
        exec(
            ...
            vec![
                String::from("-rf"),
                String::from("/tmp/athena-nix-experiment-dory-master/nixos/home-manager"),
                String::from("/tmp/athena-nix-experiment-dory-master/nixos/hosts"),
                String::from("/tmp/athena-nix-experiment-dory-master/nixos/modules"),
                String::from("/tmp/athena-nix-experiment-dory-master/nixos/pkgs"),
                String::from("/tmp/athena-nix-experiment-dory-master/nixos/configuration.nix"),
                String::from("/tmp/athena-nix-experiment-dory-master/nixos/default.nix"),
